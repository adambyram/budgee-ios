...
- (NSString *)databaseFilepath
{
	...
	/*	if (![[NSFileManager defaultManager] fileExistsAtPath:databaseFilepath]){
			...
			NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"budgee.db"];
			success = [fileManager copyItemAtPath:defaultDBPath toPath:databaseFilepath error:&error];
			if (!success) {
